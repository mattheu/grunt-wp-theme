...
```
git clone git@github.com:mattheu/grunt-wp-theme.git ~/.grunt-init/wp-theme
```

### Windows Users

```
git clone git@github.com:mattheu/grunt-wp-theme.git %USERPROFILE%/.grunt-init/wp-theme
```
...
The `/img/src` directory exists only to allow you to keep track of source files (like PSDs or separate images that have been merged into sprites).  This helps keep source files under version control.
